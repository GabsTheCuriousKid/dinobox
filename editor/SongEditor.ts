...
export class SongEditor {
	...
	private readonly View_language: string | null = window.localStorage.getItem("language") === "german" ? "Im Songplayer anzeigen" : window.localStorage.getItem("language") === "english" ? "View in Song Player" : window.localStorage.getItem("language") === "spanish" ? "Ver en el / la reproductor de canciones" : window.localStorage.getItem("russian") === "russian" ? "Посмотреть в плеере песен" : null
	private readonly HTML_language: string | null = window.localStorage.getItem("language") === "german" ? "HTML-Einbettungscode kopieren" : window.localStorage.getItem("language") === "english" ? "Copy HTML Embed Code" : window.localStorage.getItem("language") === "spanish" ? "Copiar el código de inserción HTML" : window.localStorage.getItem("russian") === "russian" ? "Скопировать HTML-код для вставки" : null
	private readonly Recover_language: string | null = window.localStorage.getItem("language") === "german" ? "Aktuelles Lied wiederherstellen" : window.localStorage.getItem("language") === "english" ? "Recover Recent Song..." : window.localStorage.getItem("language") === "spanish" ? "Recuperar canción reciente..." : window.localStorage.getItem("russian") === "russian" ? "Восстановить недавнюю песню..." : null
